         ...
         <div class="tengah">
             ...
             <div class="list">
                 <div class="kartu-tutor">
                     <img src="css/igcon.png" width="200" height="200"/>
                     <h1>Instagram</h1>
                     <p>@aliciousness_ig</p>
                 </div>
                 <div class="kartu-tutor">
                     <img src="css/twecon.png" width="200" height="200"/>
                     <h1>Twitter</h1>
                     <p>@aliciousness_tweet</p>
                 </div>
                 <div class="kartu-tutor">
                     <img src="css/callcon.png" width="200" height="200"/>
                     <h1>Call Service</h1>
                     <p>*666#</p>
                 </div>
             </div>
